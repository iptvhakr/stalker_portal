...
VALUES    ('application-catalog',    'smart-application-list',                      0, 'Application for SmartLauncher. List of applications'),
          ...
          ('application-catalog',    'smart-application-add',                       1, 'Application for SmartLauncher. Add new application by URL of the repository'),
          ...
          ('application-catalog',    'smart-application-reset-all',                 1, 'Application for SmartLauncher. Reset all applications');
