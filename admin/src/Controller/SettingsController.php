...
class SettingsController extends \Controller\BaseStalkerController {
    ...
    private function getEpgDropdownAttribute(){
        return array(
            ...
            array('name'=>'id_prefix',  'title'=>'Префикс',         'checked' => TRUE),
            array('name'=>'uri',        'title'=>'URL',             'checked' => TRUE),
            array('name'=>'etag',       'title'=>'Хеш файла XMLTV', 'checked' => TRUE),
            array('name'=>'updated',    'title'=>'Дата обновления', 'checked' => TRUE),
