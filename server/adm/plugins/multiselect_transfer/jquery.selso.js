...
$(function () {
    ...
    // add_all/remove_all buttons for combo select boxes
    ...
    $(document).on('dblclick', 'select.left option, select.right option', function(){
        var fromclass = $(this).closest('select').hasClass('left')? 'left': 'right';
        var toclass = fromclass == 'left'? 'right' : 'left';
