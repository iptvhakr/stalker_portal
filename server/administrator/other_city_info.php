...
<tr>
    ...
    <table align="center">
        ...
        <tr>
           ...
           <td>
            <input type="button" value="<?= htmlspecialchars(_('Save'), ENT_QUOTES)?>" onclick="save()">&nbsp;<input type="button" value="<?= htmlspecialchars(_('New'), ENT_QUOTES)?>" onclick="document.location='other_city_info.php'">
           </td>
        </tr>
    </table>
    </form>
