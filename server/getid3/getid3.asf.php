...
//								return false;
			...
			case ASF_Content_Description_Object:
				...
				foreach ($ASFcommentKeysToCopy as $keytocopyfrom => $keytocopyto) {
					if (!empty($ThisFileInfo['asf']['content_description'][$keytocopyfrom.'_ascii'])) {
						$ThisFileInfo['asf']['comments']["$keytocopyto"] = $ThisFileInfo['asf']['content_description'][$keytocopyfrom.'_ascii'];
					}
				}
			...
			case ASF_Extended_Content_Description_Object:
				...
				for ($ExtendedContentDescriptorsCounter = 0; $ExtendedContentDescriptorsCounter < $ThisFileInfo['asf']['extended_content_description']['content_descriptors_count']; $ExtendedContentDescriptorsCounter++) {
					...
					switch ($ThisFileInfo['asf']['extended_content_description']['content_descriptors'][$ExtendedContentDescriptorsCounter]['name_ascii']) {
						case 'WM/AlbumArtist':
							$ThisFileInfo['asf']['comments']['artist'] = $ThisFileInfo['asf']['extended_content_description']['content_descriptors'][$ExtendedContentDescriptorsCounter]['value_ascii'];
							break;
