...
/* line-1 */
        gs.items[0][0].val = b1[0];gs.items[0][1].val = b1[1];gs.items[0][2].val = b1[2];
        gs.items[0][3].val = b2[0];gs.items[0][4].val = b2[1];gs.items[0][5].val = b2[2];
        gs.items[0][6].val = b3[0];gs.items[0][7].val = b3[1];gs.items[0][8].val = b3[2];
/* line-2 */
        gs.items[1][0].val = b3[0];gs.items[1][1].val = b3[1];gs.items[1][2].val = b3[2];
        gs.items[1][3].val = b1[0];gs.items[1][4].val = b1[1];gs.items[1][5].val = b1[2];
        gs.items[1][6].val = b2[0];gs.items[1][7].val = b2[1];gs.items[1][8].val = b2[2];
/* line-3 */
        gs.items[2][0].val = b2[0];gs.items[2][1].val = b2[1];gs.items[2][2].val = b2[2];       
        gs.items[2][3].val = b3[0];gs.items[2][4].val = b3[1];gs.items[2][5].val = b3[2];
        gs.items[2][6].val = b1[0];gs.items[2][7].val = b1[1];gs.items[2][8].val = b1[2];
/* line-4 */
        gs.items[3][0].val = b3[1];gs.items[3][1].val = b3[2];gs.items[3][2].val = b3[0];
        gs.items[3][3].val = b1[1];gs.items[3][4].val = b1[2];gs.items[3][5].val = b1[0];
        gs.items[3][6].val = b2[1];gs.items[3][7].val = b2[2];gs.items[3][8].val = b2[0];
/* line-5 */
        gs.items[4][0].val = b2[1];gs.items[4][1].val = b2[2];gs.items[4][2].val = b2[0];
        gs.items[4][3].val = b3[1];gs.items[4][4].val = b3[2];gs.items[4][5].val = b3[0];
        gs.items[4][6].val = b1[1];gs.items[4][7].val = b1[2];gs.items[4][8].val = b1[0];
/* line-6 */
        gs.items[5][0].val = b1[1];gs.items[5][1].val = b1[2];gs.items[5][2].val = b1[0];
        gs.items[5][3].val = b2[1];gs.items[5][4].val = b2[2];gs.items[5][5].val = b2[0];
        gs.items[5][6].val = b3[1];gs.items[5][7].val = b3[2];gs.items[5][8].val = b3[0];
/* line-7 */
        gs.items[6][0].val = b1[2];gs.items[6][1].val = b1[0];gs.items[6][2].val = b1[1];
        gs.items[6][3].val = b2[2];gs.items[6][4].val = b2[0];gs.items[6][5].val = b2[1];
        gs.items[6][6].val = b3[2];gs.items[6][7].val = b3[0];gs.items[6][8].val = b3[1];
/* line-8 */
        gs.items[7][0].val = b3[2];gs.items[7][1].val = b3[0];gs.items[7][2].val = b3[1];
        gs.items[7][3].val = b1[2];gs.items[7][4].val = b1[0];gs.items[7][5].val = b1[1];
        gs.items[7][6].val = b2[2];gs.items[7][7].val = b2[0];gs.items[7][8].val = b2[1];
/* line-9*/
        gs.items[8][0].val = b2[2];gs.items[8][1].val = b2[0];gs.items[8][2].val = b2[1];       
        gs.items[8][3].val = b3[2];gs.items[8][4].val = b3[0];gs.items[8][5].val = b3[1];
        gs.items[8][6].val = b1[2];gs.items[8][7].val = b1[0];gs.items[8][8].val = b1[1];
        
        
        var 
            original_order = [[0,1,2],[3,4,5],[6,7,8]],
        ...
        setTimeout(
            function() {
                ...
                VKBlock = false;
                if(self.vars.timer!=null) {clearInterval(self.vars.timer);}
        ...
        for(var i = 0; i< items.length; i++) {
            ...
            if(gs.items[y][x].val!=-1) {
                ...
                if(this.vars.tips==true) {
                    var arr = this.getArrToCell(x,y, byID('p_' + j).parentNode.id),
                          _out= '',
                          str = new Array();
                    if(gs.items[y][x].delCand.length>0) {log("x: "+x+", y: "+y+", delCand: "+gs.items[y][x].delCand.toString()+"\n"+arr.toString()+"\n"+'* * * * * * * ');}
    ...
    "fillOne":function(x, y, set_num, _x, _y){
        var id = gs.infoItems.x * _y + _x,
            flag;
        id = (id<10) ? '0' + id : '' + id;
        var arr = this.getArrToCell(_x,_y, byID('p_' + id).parentNode.id); // возможные варианты
        if(_x==x && _y == y) {
    ...
    "fillCellCand":function(x,y){
        ...
        id = (id<10) ? '0' + id : '' + id;
        var arr = this.getArrToCell(x,y, byID('p_' + id).parentNode.id); // возможные варианты
        if(gs.items[y][x].val == -1) {
            if(this.vars.tips==true) {
                var _out ="",
                    _s = [1,2,3,4,5,6,7,8,9];
    ...
    "fillVariantsXY":function(x,y, set_num){
        ...
        if(set_num!=-1) {
            ...
            if(gs.items[y][x].flag == true) {
                ...
                //gs.items[y][x].val =-1;
                //byID('p_' + id).innerHTML = "c"; // высыпать кандидатов
    ...
    "PressNUM":function(code){
        ...
        //log(byID('p_' + (gs.position.current.y * gs.infoItems.x + gs.position.current.x)) .parentNode.id);
        if(this.vars.modeCandidats==true) {
            ...
            if(iteraciy==counter) {
                byID('finish').style.display = 'block';
                if(this.vars.timer!=null) {clearInterval(this.vars.timer);}
