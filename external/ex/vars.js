...
var NORMAL_MODE  = 0,
    LSEARCH_MODE = 1,
	languages = [{label:'English', id:0, langVal:'en'}, {label:'Русский', id:1, langVal:'ru'}, {label:'Українська', id:2, langVal:'uk'}],
    proxy = '',
