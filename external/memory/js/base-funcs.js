...
function log(line) {
    if (modes.debug && !modes.emulate) {
        gSTB.Debug(typeof line == 'string' ? line : print_r(line));
    }
    if (modes.debug && modes.emulate) {
        console.log(line);
    }
...
function print_r(arr, level) {
    ...
    if (typeof(arr) == 'object') {
        for (var item in arr) {
            ...
            elseprint_red_text += level_padding + "'" + item + "'=> \"" + value + "\"\n";
        }
...
function empty(mixed_var) {
    if (mixed_var === "" || mixed_var === null || mixed_var === false || typeof mixed_var === 'undefined' || typeof mixed_var === 'NaN') {
        return true;
    }
