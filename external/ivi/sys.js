...
function sendreq(url, callback, hide_blackbg, callarg){
    try {
        ...
        //request.setRequestHeader("Cookie", "uper=100");
        //request.setRequestHeader("Cookie2", "uper=100");
...
function sendreq_post(url, callback,text){
    try {
