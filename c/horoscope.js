    ...
    function horoscope_constructor(){
        ...
        this.init = function(){
            ...
            for (var i=0; i<=2; i++){
                ...
                li.style.background = 'url(i'+img_prefix+'/horoscope_menu_button_1_' + (i+1) + '_a.png)';
                menu.appendChild(li);
        ...
        this.fill_menu = function(){
            ...
            for(var i=0; i<3; i++){
                ...
                _debug('url(i'+ img_prefix +'/horoscope_menu_button_1_' + this.items_map[i] + '_' + letter +'.png)');
                
                this.menu_map[i].style.background = 'url(i' + img_prefix + '/horoscope_menu_button_1_' + this.items_map[i] + '_' + letter +'.png)';
            }
        };
